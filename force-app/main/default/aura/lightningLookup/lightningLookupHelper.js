...
searchRecordsHelper : function(component, event, helper, value) {
        ...
        action.setParams({
            ...
            'parent':component.get('v.parentid'),
     ...
     //event
     FireEvent : function(component, event, helper, value) {
    
            alert('**********recId:'+ component.get('v.value'));
            var myEvent = $A.get("e.c:Vf_ComponentEvent");
         alert(myEvent);
	         myEvent.setParams({
                "recId":value
